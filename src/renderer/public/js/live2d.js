!(function (t) {
  ...
  function (t, i, e) {
    ...
    function v() {
      for (
        var t = ['webgl', 'experimental-webgl', 'webkit-3d', 'moz-webgl'], i = 0;
        i < t.length;
        i++
      )
        try {
  ...
  function (t, i, e) {
    ...
    ;(function (t) {
      !(function () {
        ...
        function p() {
          At ||
            ((this._$vo = null), (this._$F2 = null), (this._$ao = 400), (this._$1S = 400), p._$42++)
        }
        function f() {
          At ||
            ((this.p1 = new c()),
        ...
        ;(It._$ni = function (t, i, e, r, o, n, s, _, a) {
          ...
          (D.prototype._$Q2 = function (t, i) {
            for (var e, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0; _ < o; _++) {
              ...
              if (
                ((e = a.getParamIndex(n)),
                e == x._$ds && ((e = t.getParamIndex(a.getParamID())), a._$Pb(e, n)),
                e < 0)
              )
        ...
        ;(wt.STATE_FIRST = 'STATE_FIRST'),
          ...
          (Z.transformPoints_sdk2 = function (i, e, r, o, n, s, _, a) {
            for (
              var h, l, $, u = r * n, p = 0, f = 0, c = 0, d = 0, g = 0, y = 0, m = !1, T = o;
              T < u;
              T += n
            ) {
              var P, S, v, L
        ...
        ;(at._$yr = !1),
          ...
          (mt.prototype.compileShader = function (t, i) {
            ...
            if (
              (e.shaderSource(o, r), e.compileShader(o), !e.getShaderParameter(o, e.COMPILE_STATUS))
            ) {
        ...
        ;(St.prototype._$bT = function () {
          ...
          (Lt._$kT = [
            ...
            0.220798, 0.232844, 0.244854, 0.256827, 0.268761, 0.280654, 0.292503, 0.304308,
            0.316066, 0.327776, 0.339436, 0.351044, 0.362598, 0.374097, 0.385538, 0.396921,
            0.408243, 0.419502, 0.430697, 0.441826, 0.452888, 0.463881, 0.474802, 0.485651,
            0.496425, 0.507124, 0.517745, 0.528287, 0.538748, 0.549126, 0.559421, 0.56963, 0.579752,
            0.589785, 0.599728, 0.609579, 0.619337, 0.629, 0.638567, 0.648036, 0.657406, 0.666676,
            0.675843, 0.684908, 0.693867, 0.70272, 0.711466, 0.720103, 0.72863, 0.737045, 0.745348,
            0.753536, 0.76161, 0.769566, 0.777405, 0.785125, 0.792725, 0.800204, 0.807561, 0.814793,
            0.821901, 0.828884, 0.835739, 0.842467, 0.849066, 0.855535, 0.861873, 0.868079,
            0.874153, 0.880093, 0.885898, 0.891567, 0.897101, 0.902497, 0.907754, 0.912873,
            0.917853, 0.922692, 0.92739, 0.931946, 0.936359, 0.940629, 0.944755, 0.948737, 0.952574,
            0.956265, 0.959809, 0.963207, 0.966457, 0.96956, 0.972514, 0.97532, 0.977976, 0.980482,
